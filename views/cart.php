            ...
            <div class="col-lg-4">
                <div class="bg-light rounded p-4">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <h6>Subtotal</h6>
                        <h6 id="summary-subtotal"><?php echo number_format($subtotal ?? 0, 0, ',', '.'); ?>đ</h6>
                    </div>
                    <div class="d-flex justify-content-between mb-3">
                        <h6>VAT (8%)</h6>
                        <h6 id="summary-tax"><?php echo number_format($tax_amount ?? 0, 0, ',', '.'); ?>đ</h6>
                    </div>
                    <div class="d-flex justify-content-between mb-3">
                        <h6>Shipping</h6>
                        <h6 id="summary-shipping"><?php echo number_format($shipping ?? 30000, 0, ',', '.'); ?>đ</h6>
                    </div>
                    <div class="d-flex justify-content-between mb-4">
                        <h5>Total</h5>
                        <h5 id="summary-total"><?php echo number_format($final_total ?? 0, 0, ',', '.'); ?>đ</h5>
                    </div>

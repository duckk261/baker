<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold">Category Management <span class="badge bg-danger fs-6 ms-2"></span></h2>
                ...
                <table class="table table-hover align-middle border-bottom">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th scope="col" class="py-3">Category Name</th>
                    ...
                    <tbody class="border-top-0">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <?php else: ?>
                                        <span class="badge bg-danger px-3 py-2 rounded-1">Hidden</span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="javascript:void(0);" onclick="if(confirm('Are you sure you want to delete this category?')) window.location.href='index.php?action=delete_category&id=<?php echo $c_id; ?>';" class="btn btn-danger btn-sm rounded-1" title="Delete">
                        ...
                        <?php 
                            ...
                            echo '<tr><td colspan="6" class="text-center py-4 text-muted">No categories found!</td></tr>';
                        }
                        ?>
                    </tbody>
                </table>

            ...
            <tbody>
                ...
                if ($products && mysqli_num_rows($products) > 0) {
                    while ($row = mysqli_fetch_assoc($products)) {
                        ...
                        // 1. CHUẨN BỊ BIẾN TRẠNG THÁI TRƯỚC KHI IN
                        ...
                        // 2. NHÉT BIẾN VÀO TRONG CHUỖI ECHO
                        echo "<tr>
                                <td>#{$p_id}</td>
                                ...
                                <td class='text-center'>
                                    ...
                                    <a href='index.php?page=edit_product&id={$p_id}' class='btn btn-sm btn-success rounded-1 me-1' title='Edit'><i class='fas fa-edit'></i></a>
